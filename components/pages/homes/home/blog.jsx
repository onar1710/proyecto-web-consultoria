                            ...
                            <div className="blog__one-item">
                                <div className="blog__one-item-image">
                                    ...
                                    <div className="blog__one-item-image-date">
                                        ...
                                        <span className="text-five">{data.month}</span>
                                    </div>
                                </div>
                                <div className="blog__one-item-content">
                                    <div className="blog__one-item-content-meta">
                                        <ul>
                                            <li><Link href="#"><i className="far fa-user"></i>Por Admin</Link></li>
                                            <li><Link href="#"><i className="far fa-comment-dots"></i>{data.comment} Comentarios</Link></li>
                                        </ul>
                                    </div>
