					...
					<div className="blog__two-item page">
						...
						<div className="blog__two-item-content">
							<div className="blog__two-item-content-meta">
								<ul>
									<li><a href="#"><i className="far fa-user"></i>Por Admin</a></li>
									<li><a href="#"><i className="far fa-comment-dots"></i>{data.comment} Comentarios</a></li>
								</ul>
							</div>
							<h4><Link href={`/blog/${data.id}`}>{data.title}</Link></h4>
							<Link className="btn-six" href={`/blog/${data.id}`}>Leer Más<i className="far fa-chevron-double-right"></i></Link>
						</div>
					</div>
				</div>
            ))}            
