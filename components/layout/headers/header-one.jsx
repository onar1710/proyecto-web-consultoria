...
import logo1 from "../../../public/leexms-logo.svg";
                    ...
                    <div className="row">
                        <div className="col-xl-5 col-md-6">
                            <div className="top__bar-left">
                                <Link href="tel:+18099990084"><i className="far fa-map-marker-alt"></i>+1 (809) 999-0083</Link>
                            </div>
                        </div>
                    ...
                    <div className="header__area-menubar">
                        ...
                        <div className="header__area-menubar-right">
                            <div className="header__area-menubar-right-box">
                                ...
                                <Link className="btn-one" href="/request-quote">Solicitar Cotización<i className="far fa-chevron-double-right"></i></Link>
                                </div>
